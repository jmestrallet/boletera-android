...
Instalá **boletera-prueba-0.1.7.apk** encima de la versión anterior, sin desinstalarla, para conservar tu acceso guardado. Esta candidata incluye pagos reales con Prex/eBROU mediante Chrome; la aceptación de esa excepción de interfaz todavía está pendiente.
