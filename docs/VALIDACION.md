...
Se corrigi� la cadena de confianza de Sistarbanc para Android 11. En el OnePlus 6T f�sico se reprodujeron los rechazos de ambos dominios y se verific� HTTPS y WebView con la configuraci�n corregida, mediante una app de diagn�stico separada sin operaci�n ni cuenta. [Evidencia TLS](TLS-ANDROID11.md). El recorrido de pago completo sigue pendiente.
