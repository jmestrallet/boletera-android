...
1. Mantené apretado **Carga Express** durante 1,2 segundos. El control muestra el medio guardado y el importe mínimo antes del gesto, llena su anillo, extiende doce líneas radiales y emite pulsos. El tiempo del gesto no depende de la velocidad de animación configurada en Android. Soltar antes cancela; un toque corto abre la ayuda sin iniciar una solicitud.
