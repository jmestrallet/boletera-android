...
try {
    ...
    Copy-Item app/build/outputs/apk/release/app-release.apk outputs/boletera-prueba-0.1.8.apk -Force
    Get-FileHash outputs/boletera-prueba-0.1.8.apk -Algorithm SHA256
