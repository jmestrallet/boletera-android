...
try {
    ...
    Copy-Item app/build/outputs/apk/release/app-release.apk outputs/boletera-prueba-0.1.1.apk -Force
    Get-FileHash outputs/boletera-prueba-0.1.1.apk -Algorithm SHA256
